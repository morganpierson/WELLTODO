...
function todosReducer() {
  ...
  switch (action.type) {
    ...
    case UPDATE_TODO:
      ...
      });return { todos: [].concat(_toConsumableArray(currentTodoToUpdate.slice(0, indexToUpdate)), [newTodoToUpdate], _toConsumableArray(currentTodoToUpdate.slice(indexToUpdate + 1))) };
    default:
      return state;
  }
}
